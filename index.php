...
$sql= " select * from cart where user_id='$cid' and  valid='1'";
$data = mysqli_query($con, $sql);
$ro=mysqli_num_rows($data);
...
<meta name="description" content="MobiStore Online Store">
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/phone.png" alt=""></div>+91 7760229848</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/mail.png" alt=""></div><a href="mailto:uakshaynayak@gmail.com">akshay@gmail.com</a></div>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="#">MobiStore</a></div>
						</div>
					</div>
						...
						<div class="header_search">
							<div class="header_search_content">
								<div class="header_search_form_container">
									<form action="shopsearch.php" method="POST" class="header_search_form clearfix">
										<input name="name" type="search" required="required" class="header_search_input" placeholder="Search for products...">
					...
					<div class="col-lg-4 col-9 order-lg-3 order-2 text-lg-left text-right">
						<div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
							<!-- Wishlist <div class="wishlist d-flex flex-row align-items-center justify-content-end">
							...
							<div class="cart">
								<div class="cart_container d-flex flex-row align-items-center justify-content-end">
									<div class="cart_icon">
										...
										<div class="cart_count"><span><?php echo $ro; ?></span></div>
									</div>
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								<div class="cat_menu_title d-flex flex-row align-items-center justify-content-start">
									...
									<div class="cat_menu_text">Brands</div>
								</div>

								<ul class="cat_menu">
									<li><a  class="clc" href="/web/project/shop.php?brand=Google">Google</a></li>
								<li><a  class="clc" href="/web/project/shop.php?brand=Meizu">Meizu</a></li>
								<li><a  class="clc" href="/web/project/shop.php?brand=OnePlus">OnePlus</a></li>
								<li><a  class="clc" href="/web/project/shop.php?brand=Vivo">Vivo</a></li>
								<li><a  class="clc" href="/web/project/shop.php?brand=Oppo">Oppo</a></li>
								<li><a  class="clc" href="/web/project/shop.php?brand=Xiaomi">Xiaomi</a></li>
								</ul>
							</div>
							...
							<div class="main_nav_menu ml-auto">
								<ul class="standard_dropdown main_nav_dropdown">
									...
									<li><a href="shop2.php">Shop Now<i class="fas fa-chevron-down"></i></a></li>
	...
	<div class="banner">
		...
		<div class="container fill_height">
			<div class="row fill_height">
				<div class="banner_product_image"><img src="images/iphone11.png" alt=""></div>
				<div class="col-lg-5 offset-lg-4 fill_height">
					<div class="banner_content">
						<h1 class="banner_text">new era of smartphones</h1>
						<div class="banner_price"><span>₹140000</span>₹120000</div>
						<div class="banner_product_name">Apple Iphone XS MAX PRO</div>
						<div class="button banner_button"><a href="shop.php?brand=apple">Shop Now</a></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							...
							<div class="char_subtitle">from Rs.10000</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">30-Days Return</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">Payment Method</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							...
							<div class="char_subtitle">Upto Rs 30000</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 advert_col">
					...
					<div class="advert d-flex flex-row align-items-center justify-content-start">
						<div class="advert_content">
							...
							<div class="advert_text">B&O Earphone with surround effect</div>
						</div>
				...
				<div class="col-lg-4 advert_col">
					...
					<div class="advert d-flex flex-row align-items-center justify-content-start">
						<div class="advert_content">
							<div class="advert_title"><a href="#">Trends 2019</a></div>
							<div class="advert_text">Wireless bluetooth Speakers</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-lg-3">
					<div class="trends_container">
						<h2 class="trends_title">Latest Fun Items</h2>
						<div class="trends_text"><p>Find the latest items which are trend in the marker</p></div>
						...
						<div class="owl-carousel owl-theme trends_slider">
							...
							<div class="owl-item">
								<div class="trends_item is_new">
									...
									<div class="trends_content">
										<div class="trends_category"><a href="#">Accessories</a></div>
										<div class="trends_info clearfix">
											<div class="trends_name"><a href="product.html">Jump White</a></div>
											<div class="trends_price">₹2000</div>
										</div>
									</div>
							...
							<div class="owl-item">
								<div class="trends_item">
									...
									<div class="trends_content">
										<div class="trends_category"><a href="#">SmartWatch</a></div>
										<div class="trends_info clearfix">
											<div class="trends_name"><a href="product.html">Samsung Charm...</a></div>
											<div class="trends_price">₹9000</div>
										</div>
									</div>
									<ul class="trends_marks">
										<li class="trends_mark trends_discount">-25%</li>
							...
							<div class="owl-item">
								<div class="trends_item is_new">
									...
									<div class="trends_content">
										<div class="trends_category"><a href="#">Drone</a></div>
										<div class="trends_info clearfix">
											<div class="trends_name"><a href="product.html">DJI Phantom 3...</a></div>
											<div class="trends_price">₹24000</div>
										</div>
									</div>
									<ul class="trends_marks">
										<li class="trends_mark trends_discount">-25%</li>
						...
						<div class="owl-carousel owl-theme reviews_slider">
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									...
									<div class="review_content">
										<div class="review_name">Akshay</div>
										<div class="review_rating_container">
											<div class="rating_r rating_r_4 review_rating"><i></i><i></i><i></i><i></i><i></i></div>
											<div class="review_time">2 day ago</div>
										</div>
										<div class="review_text"><p>best</p></div>
									</div>
								</div>
							</div>
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									...
									<div class="review_content">
										<div class="review_name">Visruth</div>
										<div class="review_rating_container">
											<div class="rating_r rating_r_4 review_rating"><i></i><i></i><i></i><i></i><i></i></div>
											<div class="review_time">2 day ago</div>
										</div>
										<div class="review_text"><p>test</p></div>
									</div>
								</div>
							</div>
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									...
									<div class="review_content">
										<div class="review_name">Surya</div>
										<div class="review_rating_container">
											<div class="rating_r rating_r_4 review_rating"><i></i><i></i><i></i><i></i><i></i></div>
											<div class="review_time">2 day ago</div>
										</div>
										<div class="review_text"><p>Hello</p></div>
									</div>
								</div>
							</div>
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									<div><div class="review_image"><img src="images/review_1.jpg" alt=""></div></div>
									<div class="review_content">
										<div class="review_name">Robert</div>
										<div class="review_rating_container">
											<div class="rating_r rating_r_4 review_rating"><i></i><i></i><i></i><i></i><i></i></div>
											<div class="review_time">2 day ago</div>
										</div>
										<div class="review_text"><p>asdfadsdasddasdasd</p></div>
									</div>
								</div>
							</div>
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									<div><div class="review_image"><img src="images/review_2.jpg" alt=""></div></div>
									<div class="review_content">
										<div class="review_name">Lucifer</div>
										<div class="review_rating_container">
											<div class="rating_r rating_r_4 review_rating"><i></i><i></i><i></i><i></i><i></i></div>
											<div class="review_time">2 day ago</div>
										</div>
										<div class="review_text"><p>Best product ever</p></div>
									</div>
								</div>
							</div>
							...
							<div class="owl-item">
								<div class="review d-flex flex-row align-items-start justify-content-start">
									<div><div class="review_image"><img src="images/review_3.jpg" alt=""></div></div>
									<div class="review_content">
										<div class="review_name">Prem</div>
										<div class="review_rating_container">
											<div class="rating_r rating_r_4 review_rating"><i></i><i></i><i></i><i></i><i></i></div>
											<div class="review_time">2 day ago</div>
										</div>
										<div class="review_text"><p>Fast delivery.</p></div>
									</div>
								</div>
							</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 footer_col">
					<div class="footer_column footer_contact">
						...
						<div class="footer_phone">+91 7760229848</div>
						<div class="footer_contact_text">
							<p>Vivekananda College of Engineering and Technologu</p>
							<p>Puttur</p>
						</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by Akshay&Vishruth
